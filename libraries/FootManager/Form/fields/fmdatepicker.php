 ...
 * @since       3.2
 */
class JFormFieldFmDatePicker extends JFormField
{
	/**
     * The form field type.
     *
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		if ($return)
		{
			$this->format    = (string) $this->element['format'] ? (string) $this->element['format'] : "YYYY-MM-DD";
	...
	{
        $date = "";
        if($this->format == "YYYY" && !empty($this->value))
            $date = "01-01-".(string)$this->value;
        ...
        $attribs_input["class"] = $this->class.' fm-input-xsmall';
        ...
        return FootManager\UI\Html\Form::textboxAppend($attribs_input, $attribs_datetimepicker, "calendar-o", $this->readonly);
