 ...
 * @since  1.6
 */
class JFormFieldFmMedia extends JFormFieldMedia
{
	/**
     * The form field type.
     *
	...
	protected function getInput()
	{
		...
		if ($this->disabled != true)
		{
			...
			$html[] = '<a class="modal btn hasTooltip" title="' . JText::_('JLIB_FORM_BUTTON_SELECT') . '" href="'
				. ($this->readonly ? ''
				: ($this->link ? $this->link
					: 'index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=' . $asset . '&amp;author='
					. $this->form->getValue($this->authorField)) . '&amp;fieldid=' . $this->id . '&amp;folder=' . $folder) . '"'
				. ' rel="{handler: \'iframe\', size: {x: 800, y: 500}}">';
			$html[] = '<span class="fa fa-image"></span></a><a class="btn hasTooltip" title="'
