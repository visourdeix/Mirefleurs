...
$width = ($thumbnail->image) ? getimagesize(\FootManager\Utilities\ImageHelper::getRemoteName($thumbnail->image))[0] : "";
...
<figure class="fm-medias-thumbnail <?php echo $class ?>" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" <?php echo $style ?>>
    ...
    <a href="<?php echo $thumbnail->url ?>" itemprop="contentUrl">
        ...
        <div class="fm-image">
            ...
            <!-- Image -->
            <?php echo FootManager\Utilities\ImageHelper::render($thumbnail->image, array("itemprop" => "thumbnail", "alt" => $thumbnail->title), !$ajax) ?>
        </div>
