 ...
 * @since  1.5
 */
class FmgalleryViewFiles extends FootManager\View\Item
{

    protected function getDescription() {
        return JText::sprintf('COM_FMGALLERY_DESCRIPTION_FILES', $this->item->category->title);
    }
    ...
    protected function getItemPageTitle() {
        return JText::_("COM_FMGALLERY_FILES")." - ".parent::getItemPageTitle();
    }
