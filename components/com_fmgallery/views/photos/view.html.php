 ...
 * @since  1.5
 */
class FmgalleryViewPhotos extends FootManager\View\Item
{

    protected function getDescription() {
        return JText::sprintf('COM_FMGALLERY_DESCRIPTION_PHOTOS', $this->item->category->title);
    }
    ...
    protected function getItemPageTitle() {
        return JText::_("COM_FMGALLERY_PHOTOS")." - ".parent::getItemPageTitle();
    }
