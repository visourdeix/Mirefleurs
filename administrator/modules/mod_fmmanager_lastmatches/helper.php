 ...
 * @since  1.5
 */
abstract class ModFmmanagerLastmatchesHelper
{
	...
	{
        // Params
        $days = JArrayHelper::getValue($params, "days", 5);
        ...
        // Filters;
        $end_date = new JDate();
        $start_date = new JDate(date('Y-m-d G:i:s', strtotime($end_date->format('Y-m-d G:i:s'). ' - '.$days.' days')));
