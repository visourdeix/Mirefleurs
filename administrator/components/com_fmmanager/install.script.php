 ...
 */
class com_fmmanagerInstallerScript
{
	/**
	...
	function install($parent)
	{
		...
		$parent->getParent()->setRedirectURL('index.php?option=com_fmmanager');
	}
	...
	function postflight($type, $parent)
	{
		if (strtolower($type) != 'uninstall') {
			...
			$folder = JPATH_ROOT . '/administrator/components/com_fmmanager/images/'.strtolower($type);
