...
<div class="row-fluid">
    <div class="span6">
        ...
        echo $this->form->renderField("ground_id");
        ?>
    </div>
    <div class="span6">
        <legend><?php echo JText::_("COM_FMMANAGER_LEGEND_CONTACTS") ?></legend>
        <?php
        ...
        <div class="control-group">
            <a id="button-coord" class="btn btn-info"><?php echo JText::_("COM_FMMANAGER_GET_COORD") ?></a>
        </div>
        <?php
