 ...
 * @since  11.1
 */
class JFormFieldSeasonsList extends JFormFieldFmList
{
    protected function getDefaultEditLink() {
        return "index.php?option=".FM_MANAGER_COMPONENT."&task=season.edit";
    }

    protected function getDefaultButtonTitle() {
        return "COM_FMMANAGER_CREATE_NEW_SEASON";
    }

    protected function getDefaultPlaceHolder() {
        return "COM_FMMANAGER_SELECT_SEASON";
    }
	...
	{
		return FMManager\Database\Models\Season::all()->toDropdown();
	}
