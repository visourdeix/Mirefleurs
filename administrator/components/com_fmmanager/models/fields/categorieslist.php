...
class JFormFieldCategoriesList extends JFormFieldFmList
{
    ...
    protected function getDefaultEditLink() {
        return "index.php?option=".FM_MANAGER_COMPONENT."&task=category.edit";
    }

    protected function getDefaultButtonTitle() {
        return "COM_FMMANAGER_CREATE_NEW_CATEGORY";
    }

    protected function getDefaultPlaceHolder() {
        return "COM_FMMANAGER_SELECT_CATEGORY";
    }
	...
	{
        return FMManager\Database\Models\Category::all()->toDropdown();
	}
