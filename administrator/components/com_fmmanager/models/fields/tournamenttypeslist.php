 ...
 * @since  11.1
 */
class JFormFieldTournamentTypesList extends JFormFieldFmList
{

    protected function getDefaultEditLink() {
        return "index.php?option=".FM_MANAGER_COMPONENT."&task=tournamenttype.edit";
    }

    protected function getDefaultButtonTitle() {
        return "COM_FMMANAGER_CREATE_NEW_TYPE";
    }

    protected function getDefaultPlaceHolder() {
        return "COM_FMMANAGER_SELECT_TYPE";
    }
	...
	{
        return FMManager\Database\Models\TournamentType::all()->toDropdown();
	}
