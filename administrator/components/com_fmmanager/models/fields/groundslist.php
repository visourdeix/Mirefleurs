 ...
 * @since  11.1
 */
class JFormFieldGroundsList extends JFormFieldFmList
{

    protected function getDefaultEditLink() {
        return "index.php?option=".FM_MANAGER_COMPONENT."&task=ground.edit";
    }

    protected function getDefaultButtonTitle() {
        return "COM_FMMANAGER_CREATE_NEW_GROUND";
    }

    protected function getDefaultPlaceHolder() {
        return "COM_FMMANAGER_SELECT_GROUND";
    }
	...
	{
        return FMManager\Database\Models\Ground::all()->toDropdown();
	}
