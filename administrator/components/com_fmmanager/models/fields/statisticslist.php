 ...
 * @since  11.1
 */
class JFormFieldStatisticsList extends JFormFieldFmList
{

    protected function getDefaultEditLink() {
        return "index.php?option=".FM_MANAGER_COMPONENT."&task=statistic.edit";
    }

    protected function getDefaultButtonTitle() {
        return "COM_FMMANAGER_CREATE_NEW_STATISTIC";
    }

    protected function getDefaultPlaceHolder() {
        return "COM_FMMANAGER_SELECT_STATISTIC";
    }
	...
	{
        return FMManager\Database\Models\Statistic::all()->toDropdown();
	}
