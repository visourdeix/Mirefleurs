 ...
 * @since  11.1
 */
class JFormFieldTacticsList extends JFormFieldFmList
{

    protected function getDefaultEditLink() {
        return "index.php?option=".FM_MANAGER_COMPONENT."&task=tactic.edit";
    }

    protected function getDefaultButtonTitle() {
        return "COM_FMMANAGER_CREATE_NEW_TACTIC";
    }

    protected function getDefaultPlaceHolder() {
        return "COM_FMMANAGER_SELECT_TACTIC";
    }
	...
	{
		return FMManager\Database\Models\Tactic::all()->toDropdown();
	}
