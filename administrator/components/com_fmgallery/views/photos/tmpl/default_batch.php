...
<div class="modal hide fade" id="collapseModal">
    <div class="modal-header">
        ...
        <h3>
            <?php echo JText::_('COM_FMGALLERY_BATCH_OPTIONS'); ?>
        </h3>
    </div>
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                ...
                <div class="control-group">
                    <div class="controls">
                        <?php echo JHtml::_('batch.item', FM_GALLERY_COMPONENT); ?>
                    </div>
                </div>
                <?php endif; ?>
                <div class="control-group">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('photo.batch');">
