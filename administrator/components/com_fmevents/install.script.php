 ...
 */
class com_fmeventsInstallerScript
{
	/**
	...
	function install($parent)
	{
		...
		$parent->getParent()->setRedirectURL('index.php?option=com_fmevents');
	}
	...
	function postflight($type, $parent)
	{
		if (strtolower($type) != 'uninstall') {
            ...
            $folder = JPATH_ROOT . '/administrator/components/com_fmevents/images/'.strtolower($type);
