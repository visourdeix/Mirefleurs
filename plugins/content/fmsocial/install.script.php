 ...
 */
class PlgContentFmsocialInstallerScript
{
	/**
	...
	function preflight($type, $parent) 
	{
		...
		jimport('FootManager.library');
            ...
            if (!FootManager\Helpers\Application::exists('com_fmsocial')) {
                JError::raiseWarning(1, JText::_('This plugin (' . $name . ') requires the FMSocial Component to be installed!'));
                return false;
            }
		}
	}
