 ...
 *
 */
class plgFmactivityFmmanagerCompetition
{

    private static function getItem($table) {
        return FMManager\Database\Models\Competition::withoutGlobalScopes()->where("id", "=", $table->id)->first();
    }
    ...
    public static function setData(&$data, $table, $eventType) {
        ...
        $data->category = $item->tournament->category->label;
