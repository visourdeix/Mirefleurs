...
class __TwigTemplate_5bf7506d5f0f1b6e2234aa1a77f7a751d9ced21f6478b4214bb168deff18d94f extends Twig_Template
{
...
<a href=\"";
    ...
    ";
        ...
        // line 11
        echo "    ";
        if ($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "text", array())) {
            echo "<span class=\"g-logo-text\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "text", array()));
            echo "</span>";
        }
        // line 12
        echo "    ";
        if ($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "tagline", array())) {
            echo "<span class=\"g-logo-tagline\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "tagline", array()));
            echo "</span>";
        }
        // line 13
        echo "</a>
";
    ...
    {
        return array (  80 => 13,  73 => 12,  66 => 11,  57 => 10,  55 => 9,  45 => 8,  42 => 7,  39 => 6,  34 => 5,  31 => 4,  28 => 3,  11 => 1,);
    }
}
...
/* */
/* <a href="{{ url }}" title="{{ particle.text|e }}" {{ rel|default('')|raw }} {{ class|default('')|raw }}>*/
/*     {% set image = url(particle.image) %}*/
/*     {% if image %}<img src="{{ url(particle.image) }}" alt="{{ particle.text }}" />{% endif %}*/
/*     {% if particle.text %}<span class="g-logo-text">{{ particle.text|e }}</span>{% endif %}*/
/*     {% if particle.tagline %}<span class="g-logo-tagline">{{ particle.tagline|e }}</span>{% endif %}*/
/* </a>*/
/* {% endblock %}*/
/* */
