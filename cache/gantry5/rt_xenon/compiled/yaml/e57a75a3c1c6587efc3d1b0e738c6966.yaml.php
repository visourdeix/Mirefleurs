...
return [
    ...
    'filename' => 'C:/wamp/www/Mirefleurs/templates/rt_xenon/gantry/presets.yaml',
    'modified' => 1477391676,
    'data' => [
        'preset1' => [
        ...
        'preset2' => [
            ...
            'styles' => [
                'base' => [
                    'background' => '#ffffff',
                    'text-color' => '#686868',
                    'background-image' => 'gantry-media://backgrounds/base/bg-02.jpg'
                ],
                'accent' => [
                    'color-1' => '#c00000',
                    'color-2' => '#007373',
        ...
        'preset3' => [
            ...
            'styles' => [
                'base' => [
                    'background' => '#ffffff',
                    'text-color' => '#686868',
                    'background-image' => 'gantry-media://backgrounds/base/bg-03.jpg'
                ],
                'accent' => [
                    'color-1' => '#00ac00',
                    'color-2' => '#d76100',
        ...
        'preset4' => [
            ...
            'styles' => [
                'base' => [
                    'background' => '#ffffff',
                    'text-color' => '#686868',
                    'background-image' => 'gantry-media://backgrounds/base/bg-04.jpg'
                ],
                'accent' => [
                    'color-1' => '#ff9000',
                    'color-2' => '#1a1eb2',
        ...
        'preset5' => [
            ...
            'styles' => [
                'base' => [
                    'background' => '#ffffff',
                    'text-color' => '#686868',
                    'background-image' => 'gantry-media://backgrounds/base/bg-05.jpg'
                ],
                'accent' => [
                    'color-1' => '#c50067',
                    'color-2' => '#017b9e',
        ...
        'preset6' => [
            ...
            'styles' => [
                'base' => [
                    'background' => '#ffffff',
                    'text-color' => '#686868',
                    'background-image' => 'gantry-media://backgrounds/base/bg-06.jpg'
                ],
                'accent' => [
                    'color-1' => '#383838',
                    'color-2' => '#6e6e6e',
