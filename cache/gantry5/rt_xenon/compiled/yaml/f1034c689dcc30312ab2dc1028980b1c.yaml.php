...
return [
    ...
    'filename' => 'C:\\wamp\\www\\Mirefleurs/templates/rt_xenon/custom/config/9/index.yaml',
    'modified' => 1477391716,
    'data' => [
        'name' => 9,
        'timestamp' => 1476730812,
        'version' => 7,
        'preset' => [
        ...
        'particles' => [
            ...
            'module' => [
                'position-module-3889' => 'Header Logo/Social',
                'position-module-9397' => 'Breadcrumb',
                'position-module-1962' => 'Partners'
            ],
            'menu' => [
                'menu-3995' => 'Menu'
            ],
            'messages' => [
                'system-messages-1193' => 'System Messages'
            ],
            'content' => [
